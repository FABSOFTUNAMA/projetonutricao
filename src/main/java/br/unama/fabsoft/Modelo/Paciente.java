package br.unama.fabsoft.Modelo;
...
public class Paciente {
	...
	public String getEtniaRegiliao() {
		return etniaRegiliao;
	}
	public void setEtniaRegiliao(String etniaRegiliao) {
		this.etniaRegiliao = etniaRegiliao;
	}
