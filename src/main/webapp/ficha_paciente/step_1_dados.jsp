...
<div class="form-group">
    <b> Data de Nascimento:</b> <input type="date"
    class="form-control col-5" id="data">
</div>
<div class="form-group">
    <b>Estado Civil:</b> <select class="custom-select col-4">
...
<div>
    <label for="textFone"><b>Telefone(fixo/celular):</b></label> <input type="text"
    class="form-control " id="textFone"
...
<div class="form-group">
    <b>Município:</b> <select class="custom-select col-4">
...
<div class="form-group">
    <label for="Naturalidade"><b>Naturalidade/Nacionalidade:</b></label> <input type="text"
    class="form-control " id="Naturalidade"
    placeholder="Nacionalidade ou Naturalidade">
    <label for="EtniaRegiao"><b>Etnia/Região</b></label>
    <input type="text" class="form-control" id="EtiniaRegiao" placeholder="Etnia e Religião">
    <label for="email"><b>E-mail:</b></label>
    <input type="text" class="form-control" id="email" placeholder="Entre com o e-mail">
</div>
